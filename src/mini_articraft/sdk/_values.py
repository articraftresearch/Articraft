...
These outlived the URDF-shaped joint model that used to own them: a vector is a
vector whether it describes a joint frame, a centre of mass, or a velocity.
"""
